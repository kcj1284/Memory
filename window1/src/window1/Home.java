...
public class Home extends JFrame {
	...
	public Home() {
		...
		class MyCircleGraph extends JPanel {
			public void paintComponent(Graphics g) {
				super.paintComponent(g);
				Graphics2D g2 = (Graphics2D) g;
				g.setColor(Color.BLUE);
				g.fillArc(10, 700, 250, 250, 90, 130);
				repaint();

			}
		}

		MyCircleGraph c = new MyCircleGraph();
		contentPane.add(c);
		...
		tf_search.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		lb_background.setBounds(0, 0, 1503, 717);
